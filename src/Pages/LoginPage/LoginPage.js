...
function LoginPage() {
  ...
  return (
    <div className='loginPage'>
      ...
      <form action="#" className="loginPage__form bg-[#202325]">

        {/* <h4 className='text-white' >Login</h4> */}

        <div className="loginPage__formInputGroup pt-10  ">
          <input
...
<Ribbon/>
      ...
      <p className='mt-10 text-white ' onClick={() => navigate("/register")}>Create New Account</p>
    </div>
  )
}
